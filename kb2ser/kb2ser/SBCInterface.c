...
//
// Last update: 1st Jan 2017 - Code method move around (identical code) to remove implicit definition warnings in AtmelStudio 7
...
const unsigned char kbShifted[132] PROGMEM = {
	...
	0 , 67 , 88 , 68 , 69 , 36 , 156 , 58 , 0 , 32 , 86 , 70 , 84 , 82 , 37 , 0 ,
...
{
	// DUNC NOTE:- Removed for my application.  I don't want my bus hanging with nowhere to go.
