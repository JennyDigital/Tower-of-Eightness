...
source_bin="$repo_root/Source/ToEVID.65b"
full_bin="$repo_root/Source/ToEVIDfull.bin"
...
cp -- "$full_bin" "$prebuilt_dir/ToEVIDfull.bin"
cp -- "$source_bin" "$prebuilt_dir/ToEVID.bin"
